...
(function (factory) {
     ...
     * The className is not exposed _yet_ but you can create an instance through jQuery method call.
     *
     * @param {object} config - You can customize any className member (property or method).
     * @className
