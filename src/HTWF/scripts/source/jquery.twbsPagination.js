...
(function ($, window, document, undefined) {
    ...
    var TwbsPagination = function (element, options) {
        ...
        this.$listContainer.addclassName(this.options.paginationclassName);
    ...
    TwbsPagination.prototype = {
        ...
        disable: function () {
            ...
            this.$listContainer.children().each(function () {
                var $this = $(this);
                if (!$this.hasclassName(_this.options.activeclassName)) {
                    $(this).addclassName(_this.options.disabledclassName);
                }
            });
        },
        ...
        buildItem: function (type, page) {
            ...
            $itemContainer.addclassName(this.options[type + 'className']);
            $itemContainer.data('page', page);
            $itemContainer.data('page-type', type);
            $itemContainer.append($itemContent.attr('href', this.makeHref(page)).addclassName(this.options.anchorclassName).html(itemText));
                ...
                switch (pageType) {
                    case 'page':
                        if ($this.data('page') === pages.currentPage) {
                            $this.addclassName(_this.options.activeclassName);
                        }
                        break;
                    case 'first':
                        $this.toggleclassName(_this.options.disabledclassName, pages.currentPage === 1);
                        break;
                    case 'last':
                        $this.toggleclassName(_this.options.disabledclassName, pages.currentPage === _this.options.totalPages);
                        break;
                    case 'prev':
                        $this.toggleclassName(_this.options.disabledclassName, !_this.options.loop && pages.currentPage === 1);
                        break;
                    case 'next':
                        $this.toggleclassName(_this.options.disabledclassName,
        ...
        setupEvents: function () {
            ...
            this.$listContainer.off('click').on('click', 'li', function (evt) {
                var $this = $(this);
                if ($this.hasclassName(_this.options.disabledclassName) || $this.hasclassName(_this.options.activeclassName)) {
                    return false;
                }
    ...
    $.fn.twbsPagination.defaults = {
        ...
        prevclassName: 'page-item prev',
        lastclassName: 'page-item last',
        firstclassName: 'page-item first',
...
(function ($) {
    ...
    $.fn.initTwbsPagination = function () {
        ...
        var n = $(t).length;
        var type = "pagination";
        if ($(this).hasclassName('load-more-grid')) type = 'load-more';
