...
(function(global, factory) {
    ...
    // keeping central set of classNamenames and selectors
    ...
    $.fn.fullpage = function(options) {
        //only once my friend!
        if($('html').hasclassName(ENABLED)){ displayWarnings(); return };
        ...
        */
        ...
        FP.reBuild = function(resizing){
            if(container.hasclassName(DESTROYED)){ return; }  //nothing to do if the plugin was destroyed
        ...
        */
        FP.setResponsive = function (active){
            var isResponsive = $body.hasclassName(RESPONSIVE);
            ...
            if(active){
                ...
                $body.removeclassName(RESPONSIVE);
            }
        }
        ...
        function init(){
            ...
            //setting the className for the body element
            setBodyclassName();
        ...
        */
        function prepareDom(){
            ...
            //adding a className to recognize the container internally in the code
            container.addclassName(WRAPPER);
            $('html').addclassName(ENABLED);

            //due to https://github.com/alvarotrigo/fullPage.js/issues/1502
            windowsHeight = $window.height();

            container.removeclassName(DESTROYED); //in case it was destroyed before initilizing it again
        ...
        */
        function styleSlides(section, slides, numSlides){
            ...
            if( startingSlide.length &&  ($(SECTION_ACTIVE_SEL).index(SECTION_SEL) !== 0 || ($(SECTION_ACTIVE_SEL).index(SECTION_SEL) === 0 && startingSlide.index() !== 0))){
                ...
                slides.eq(0).addclassName(ACTIVE);
            }
        }
        ...
        */
        ...
        /**
        * Adds internal classNamees to be able to provide customizable selectors
        * keeping the link with the style sheet.
        */
        function addInternalSelectors(){
            //adding internal className names to void problem with common ones
            $(options.sectionSelector).each(function(){
                $(this).addclassName(SECTION);
            });
            $(options.slideSelector).each(function(){
                $(this).addclassName(SLIDE);
            });
        }
        ...
        */
        function addVerticalNavigation(){
            ...
            $(SECTION_NAV_SEL).find('li').eq($(SECTION_ACTIVE_SEL).index(SECTION_SEL)).find('a').addclassName(ACTIVE);
        }
        ...
        */
        function afterRenderActions(){
            ...
            section.addclassName(COMPLETELY);
        ...
        function scrollHandler(){
            ...
            if(!options.autoScrolling || options.scrollBar){
                ...
                if(isCompletelyInViewPort(scrollDirection)){
                    if(!$(SECTION_ACTIVE_SEL).hasclassName(COMPLETELY)){
                        $(SECTION_ACTIVE_SEL).addclassName(COMPLETELY).siblings().removeclassName(COMPLETELY);
                    }
                }
                ...
                if(!currentSection.hasclassName(ACTIVE)){
                    isScrolling = true;
                    ...
                    if(canScroll){
                        currentSection.addclassName(ACTIVE).siblings().removeclassName(ACTIVE);
        ...
        */
        ...
        function MouseWheelHandler(e) {
            ...
            var isNormalScroll = $(COMPLETELY_SEL).hasclassName(NORMAL_SCROLL);
        ...
        */
        function scrollPage(element, callback, isMovementUp){
            ...
            requestAnimFrame(function(){
                ...
                if((v.activeSection.is(element) && !isResizing) || (options.scrollBar && $window.scrollTop() === v.dtop && !element.hasclassName(AUTO_HEIGHT) )){ return; }
                ...
                element.addclassName(ACTIVE).siblings().removeclassName(ACTIVE);
                lazyLoad(element);
        ...
        */
        function afterSectionLoads (v){
            ...
            playMedia(v.element);
            v.element.addclassName(COMPLETELY).siblings().removeclassName(COMPLETELY);
        ...
        */
        ...
        function slideArrowHandler(){
            ...
            if ($(this).hasclassName(SLIDES_PREV)) {
                if(isScrollAllowed.m.left){
        ...
        */
        function landscapeScroll(slides, destiny){
            ...
            destiny.addclassName(ACTIVE).siblings().removeclassName(ACTIVE);
            if(!localIsResizing){
                lazyLoad(destiny);
            }
            ...
            slidesNav.find(ACTIVE_SEL).removeclassName(ACTIVE);
            slidesNav.find('li').eq(slideIndex).find('a').addclassName(ACTIVE);
        }
        ...
        * A className `fp-responsive` is added to the plugin's container in case the user wants to use it for his own responsive CSS.
        */
        function responsive(){
        ...
        */
        function addAnimation(element){
            ...
            element.removeclassName(NO_TRANSITION);
            return element.css({
        ...
        */
        function removeAnimation(element){
            return element.addclassName(NO_TRANSITION);
        }
        ...
        function activateNavDots(name, sectionIndex){
            if(options.navigation){
                $(SECTION_NAV_SEL).find(ACTIVE_SEL).removeclassName(ACTIVE);
                if(name){
                    $(SECTION_NAV_SEL).find('a[href="#' + name + '"]').addclassName(ACTIVE);
                }else{
                    $(SECTION_NAV_SEL).find('li').eq(sectionIndex).find('a').addclassName(ACTIVE);
                }
            }
        }
        ...
        function activateMenuElement(name){
            if(options.menu){
                $(options.menu).find(ACTIVE_SEL).removeclassName(ACTIVE);
                $(options.menu).find('[data-menuanchor="'+name+'"]').addclassName(ACTIVE);
            }
        }
        ...
        */
        ...
        function addTableclassName(element){
            element.addclassName(TABLE).wrapInner('<div className="' + TABLE_CELL + '" style="height:' + getTableHeight(element) + 'px;" />');
        }
        ...
        function getTableHeight(element){
            ...
            if(options.paddingTop || options.paddingBottom){
                var section = element;
                if(!section.hasclassName(SECTION)){
        ...
        /**
        * Adds a css3 transform property to the container className with or without animation depending on the animated param.
        */
        function transformContainer(translate3d, animated){
            ...
            //syncronously removing the className after the animation has been applied.
            setTimeout(function(){
                container.removeclassName(NO_TRANSITION);
            },10);
        }
        ...
        */
        function scrollPageAndSlide(destiny, slide){
            ...
            if (destiny !== lastScrolledDestiny && !section.hasclassName(ACTIVE)){
        ...
        */
        function addSlidesNavigation(section, numSlides){
            ...
            //top or bottom
            nav.addclassName(options.slidesNavPosition);
            ...
            nav.find('li').first().find('a').addclassName(ACTIVE);
        }


        /**
        * Sets the state of the website depending on the active section/slide.
        * It changes the URL hash when needed and updates the body className.
        */
        ...
        */
        ...
        /**
        * Sets a className for the body of the page depending on the active section / slide
        */
        function setBodyclassName(){
            ...
            //removing previous anchor classNamees
            var classNameRe = new RegExp('\\b\\s?' + VIEWING_PREFIX + '-[^\\s]+\\b', "g");
            $body[0].classNameName = $body[0].classNameName.replace(classNameRe, '');

            //adding the current anchor
            $body.addclassName(VIEWING_PREFIX + '-' + text);
        }
        ...
        */
        FP.destroy = function(all){
            ...
            container.addclassName(DESTROYED);
        ...
        */
        function destroyStructure(){
            ...
            // remove .fp-enabled className
            $('html').removeclassName(ENABLED);

            // remove all of the .fp-viewing- classNamees
            $.each($body.get(0).classNameName.split(/\s+/), function (index, classNameName) {
                if (classNameName.indexOf(VIEWING_PREFIX) === 0) {
                    $body.removeclassName(classNameName);
                }
            });

            //removing added classNamees
            $(SECTION_SEL + ', ' + SLIDE_SEL).each(function(){
                options.scrollOverflowHandler.remove($(this));
                $(this).removeclassName(TABLE + ' ' + ACTIVE);
            });
...
(function ($) {
    ...
    function updateHorizontalMenu(i) {
        $("#fullpage-horizontal-menu li").removeclassName("active").removeclassName("current-active");
        $("#fullpage-horizontal-menu li:eq(" + i + ")").addclassName("active").addclassName("current-active");
    ...
    function updateCSS(index) {
        if (index == 1) {
            ...
            $(".scroll-show").animate({ opacity: 0 }, 0, function () { $(".scroll-show").removeclassName("showed"); });
            $(".scroll-change").removeclassName("scroll-css");
            $(".menu-transparent.scroll-change").addclassName("bg-transparent");
            CSSupdated = 0;
        } else {
            if (!CSSupdated) {
                $(".scroll-hide").css("display", "none");
                $(".scroll-show").addclassName("showed").animate({ opacity: 1 }, 0);
                $(".scroll-change").addclassName("scroll-css");
                $(".menu-transparent.scroll-change").removeclassName("bg-transparent");
                CSSupdated = 1;
            }
        }
    }
    ...
    $(document).ready(function () {
        ...
        if ($("#fullpage-main .fp-wp-footer").length) {
            ...
            $(f).html('<div className="content">' + $(f2).find(".content").html() + '</div>');
            $(f).attr("className", "section fp-auto-height " + $(f2).attr("className"));
        ...
        if (!isFullpage) {
            ...
            $(menu_).closest("header").addclassName("one-page-menu");
            $('body').addclassName("overflow-visble");
        }
        ...
        $("#fullpage-main li:first-child").addclassName("active current-active");
        ...
        var options = {
            ...
            onSlideLeave: function (anchorLink, index, slideIndex, direction, nextSlideIndex) {
                ...
                if (!isEmpty(menu)) {
                    $(menu).find("li").removeclassName("current-active").removeclassName("active");
                    $(menu).find("li").eq(nextSlideIndex).addclassName("current-active").addclassName("active");
                }
            }
        }
